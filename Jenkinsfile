        ...
        stage("Deploy to K8s using Helm"){
            ...
            steps{
                script{
                    ...
                    sh 'helm install /home/ubuntu/jenkins/workspace/cicd-pipeline/helm-charts/java-app-chart /home/ubuntu/jenkins/workspace/cicd-pipeline/java-app-chart-${CHART_VALUE}.tgz'
